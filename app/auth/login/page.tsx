  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ background: 'var(--vscode-bg)', color: 'var(--vscode-text)' }}>
      <div className="w-full max-w-sm p-8 rounded-lg border" style={{ background: 'var(--vscode-sidebar)', borderColor: 'var(--vscode-border)' }}>
        <h1 className="text-xl font-bold mb-2 text-center" style={{ color: 'var(--vscode-accent)' }}>Welcome to CodePaste</h1>
        <p className="text-xs text-center mb-6" style={{ color: 'var(--vscode-text-secondary)' }}>Sign in to create, manage, and delete your pastes</p>
